      ...
      <div className="footer__container">
        <div className="footer__grid">
          <div className="footer__branding">
            <div className="footer__logo">
              <Logo />
              <h3 className="footer__title">{settings.title}</h3>
            </div>
          ...
          <div className="footer__column">
            ...
            <p className="footer__description">Stay updated with our latest news and offers.</p>
            <form className="footer__newsletter-form">
              ...
              />
              <button type="submit" className="button button--primary footer__newsletter-button">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="footer__copyright">
          <p>
            ...
            <a href="https://boon-digital.nl">Boon Digital</a>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
