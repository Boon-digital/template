...
/**
 * Reusable function to create a Media & Text section with proper validation
 * Based on learnings from Media & Text section task (2024-12-19)
 */
async function createMediaTextSection(options = {}) {
  const {
...
module.exports = { createMediaTextSection, verifyMediaTextSection, example };
